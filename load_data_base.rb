...
order_2 = Order.new(book_5, reader_4, '15.03.22')
order_3 = Order.new(book_2, reader_4, '150320')
order_4 = Order.new(book_2, reader_2, '18.07.21')
order_5 = Order.new(book_3, reader_5, '21.03.22')
order_6 = Order.new(book_4, reader_4, '20.03.18')
order_7 = Order.new(book_5, reader_4, '20.03.20')
order_8 = Order.new(book_8, reader_2, '20.04.21')
