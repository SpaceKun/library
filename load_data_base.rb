...
order_3 = Order.new(book_7, reader_4, '150320')
order_4 = Order.new(book_7, reader_2, '18.07.21')
order_5 = Order.new(book_7, reader_5, '21.03.22')
order_6 = Order.new(book_7, reader_4, '20.03.18')
