module DatabaseFiller
  ...
  def fill_with_fake_data
    ...
    file = File.new(AUTHORS_YML_PATH, 'w+')
    ...
    file = File.new(READERS_YML_PATH, 'w+')
    ...
    file = File.new(BOOKS_YML_PATH, 'w+')
    file.write(books_to_yaml)
    file.close

    order_1 = Order.new(book_2, reader_6, '10.03.20')
    order_2 = Order.new(book_1, reader_6, '15.03.22')
    order_3 = Order.new(book_3, reader_1, '150320')
    order_4 = Order.new(book_8, reader_1, '18.07.21')
    order_5 = Order.new(book_8, reader_1, '21.03.22')
    order_6 = Order.new(book_6, reader_3, '20.03.18')
    order_7 = Order.new(book_1, reader_4, '20.03.20')
